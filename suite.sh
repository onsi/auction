...
ginkgo -- -communicationMode=nats -auctioneerMode=remote -algorithm=all_revote -maxBiddingPool=20 -maxConcurrent=20
...
ginkgo -- -communicationMode=nats -auctioneerMode=remote -algorithm=hesitate -maxBiddingPool=20 -maxConcurrent=20

ginkgo -- -communicationMode=nats -auctioneerMode=remote -algorithm=all_revote -maxBiddingPool=100 -maxConcurrent=20
...
ginkgo -- -communicationMode=nats -auctioneerMode=remote -algorithm=hesitate -maxBiddingPool=100 -maxConcurrent=20

ginkgo -- -communicationMode=nats -auctioneerMode=remote -algorithm=all_revote -maxBiddingPool=20 -maxConcurrent=100
...
ginkgo -- -communicationMode=nats -auctioneerMode=remote -algorithm=hesitate -maxBiddingPool=20 -maxConcurrent=100

ginkgo -- -communicationMode=nats -auctioneerMode=remote -algorithm=all_revote -maxBiddingPool=20 -maxConcurrent=1000
...
ginkgo -- -communicationMode=nats -auctioneerMode=remote -algorithm=hesitate -maxBiddingPool=20 -maxConcurrent=1000

ginkgo -- -communicationMode=nats -auctioneerMode=remote -algorithm=all_revote -maxBiddingPool=100 -maxConcurrent=100
...
ginkgo -- -communicationMode=nats -auctioneerMode=remote -algorithm=hesitate -maxBiddingPool=100 -maxConcurrent=100

ginkgo -- -communicationMode=nats -auctioneerMode=remote -algorithm=all_revote -maxBiddingPool=100 -maxConcurrent=1000
...
ginkgo -- -communicationMode=nats -auctioneerMode=remote -algorithm=hesitate -maxBiddingPool=100 -maxConcurrent=1000
